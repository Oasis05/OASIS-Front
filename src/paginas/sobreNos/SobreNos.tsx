function SobreNos() {
    ...
    return (
        ...
        <div className="container max-w-screen-lg m-auto">
            <h1 className="text-3xl font-bold my-6 uppercase">Sobre Nós</h1>
            <p>Bem-vindo ao Oasis, onde cada compra alimenta uma missão dupla: nutrir corpos e almas, e semear um futuro mais sustentável e justo para todos.
                ...
                unindo forças com agricultores familiares para trazer até você produtos de qualidade incomparável, cultivados com amor, respeito e dedicação ao meio ambiente.
            </p>

            <h3 className="text-xl font-bold my-6 uppercase">Nossa Missão</h3>
            <p>A Oásis tem uma missão simples, porém poderosa: alimentar o corpo e a alma. Acreditamos no poder da alimentação não só como nutrição física, mas como um veículo de mudança social.
                ...
                sustentável e ética, mas também contribuímos diretamente para a luta contra a fome e a promoção de uma sociedade mais igualitária.
            </p>

            <h3 className="text-xl font-bold my-6 uppercase">Por Que Agricultura Familiar?</h3>
            <p>A agricultura familiar é o coração pulsante do nosso negócio. Escolhemos trabalhar com pequenos produtores porque sabemos que,
                ...
                a conservação do solo e da água, e a redução das emissões de carbono.
            </p>

            <h3 className="text-xl font-bold my-6 uppercase">Contribuindo para o Objetivo de Desenvolvimento Sustentável da ONU</h3>
            <p>Oasis não é apenas um e-commerce; é uma causa. Estamos comprometidos com o Objetivo de Desenvolvimento Sustentável (ODS) nº 2 da ONU:
                ...
                o incentivo à agricultura sustentável e o apoio ao pequeno agricultor, pilares fundamentais para a construção de um mundo melhor.
            </p>

            <h3 className="text-xl font-bold my-6 uppercase">Junte-se a Nós</h3>
            <p>Cada compra feita no Oasis é um passo em direção a um mundo onde ninguém vai dormir com fome, onde os produtores são valorizados e onde a sustentabilidade
                ...
                você alimenta uma cadeia de boas ações, sustentabilidade e esperança.
            </p>

            <h3 className="text-xl font-bold my-6 uppercase">Porque juntos, somos um oásis de possibilidades.</h3>
